...
export function About() {
  return (
    <section id="about" className="relative py-12 sm:py-20 bg-brand-green/[0.035] dark:bg-brand-green/[0.02] border-y border-line-site">
      ...
      <Container>
        <Reveal>
          <div className="relative max-w-3xl lg:max-w-4xl mx-auto text-center flex flex-col gap-3 sm:gap-4">
            ...
            <p className="text-[0.85rem] sm:text-base md:text-lg lg:text-xl leading-relaxed text-text-muted font-light mt-1 md:mt-2 max-w-3xl mx-auto">
