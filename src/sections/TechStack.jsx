              ...
              <section className="surface h-full rounded-[24px] p-5 sm:p-6" aria-labelledby={stackId}>
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-3">
                  {group.items.map(({ name, icon: Icon }) => (
                    <div
                      key={name}
                      className="group flex min-h-28 flex-col justify-between rounded-[20px] border border-white/10 bg-[#050816]/60 p-4 transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[#22c55e]/35 hover:bg-[#27272a]/55 hover:shadow-[0_18px_50px_rgb(34_197_94/0.045)]"
                    >
